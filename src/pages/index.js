		...
		<Section>
			...
			>
				<Text
					...
					hover-color="#030303"
					hover-font="roboto "
					hover-box-shadow="5px 10px 20px 10px --color-primary"
					hover-transition="all 2s ease 0.2s"
					hover-text-shadow="0 0 5px --color-primary"
					border-radius="20px"
					hover-border-radius="20px"
					hover-padding="10px 10px 10px 10px"
				>
					Yog Panjarale
				</Text>
				<Menu
